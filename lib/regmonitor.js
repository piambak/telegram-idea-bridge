...
const SEEN_FILE = path.join(__dirname, '..', 'seen-regulations.json');
...
const DIGEST_PROMPT = `You are a regulatory affairs analyst. The user will give you a list of newly
published Indonesian Ministry of Finance (Kemenkeu) regulations (PMK). Write a short overview
(2-4 sentences, in Indonesian) of what these new regulations cover collectively. Return ONLY the
...
module.exports = { fetchLatest, checkForNew, synthesizeOverview, scheduleDaily, msUntilNextWibHour };
